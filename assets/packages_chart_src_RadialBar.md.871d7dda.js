...
<script type="module">
  ...
  new RadialBar()
      ...
      ;
<\/script>
`)])],-1),f=d('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:RadialBar"><pre><code></code></pre></div>',3);function B(b,C,R,w,P,A){const t=r("ClientOnly");return o(),s("div",null,[h,p,n(t,null,{default:l(()=>[u]),_:1}),_,m,n(t,null,{default:l(()=>[g]),_:1}),v,x,n(t,null,{default:l(()=>[y]),_:1}),f])}var T=i(c,[["render",B]]);export{k as __pageData,T as default};
