...
<script type="module">
  ...
  new RadialBar()
      ...
      ;
<\/script>
`)])],-1),f=d("",3);function B(b,C,R,w,P,A){const t=r("ClientOnly");return o(),s("div",null,[h,p,n(t,null,{default:l(()=>[u]),_:1}),_,m,n(t,null,{default:l(()=>[g]),_:1}),v,x,n(t,null,{default:l(()=>[y]),_:1}),f])}var T=i(c,[["render",B]]);export{k as __pageData,T as default};
