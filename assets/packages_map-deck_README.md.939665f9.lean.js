import{_ as a,r as t,c as p,b as o,w as u,a as c,o as e,d as n}from"./app.8d0e5b28.js";const h='{"title":"@hpcc-js/map-deck","description":"","frontmatter":{},"headers":[{"level":2,"title":"Exported Widgets","slug":"exported-widgets"},{"level":2,"title":"Stand-alone HTML Example","slug":"stand-alone-html-example"}],"relativePath":"packages/map-deck/README.md"}',l={},i=c("",6),k=n("hpcc-vitepress",{style:{width:"100%",height:"600px"}},[n("pre",null,[n("code",null,`<div id="target" style="width:100%;height:600px">
</div>
<script type="module">
...
<\/script>
`)])],-1);function q(r,g,d,L,G,A){const s=t("ClientOnly");return e(),p("div",null,[i,o(s,null,{default:u(()=>[k]),_:1})])}var m=a(l,[["render",q]]);export{h as __pageData,m as default};
