...
<script type="module">
    ...
    new Contour()
        ...
        ;
<\/script>
`)])],-1);function u(f,_,g,y,k,x){const t=n("ClientOnly");return h(),s("div",null,[o,a(t,null,{default:r(()=>[p]),_:1}),d,a(t,null,{default:r(()=>[m]),_:1})])}var w=l(c,[["render",u]]);export{b as __pageData,w as default};
