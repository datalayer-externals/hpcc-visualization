...
<script type="module">
  ...
  new SummaryC()
      ...
      ;
<\/script>
`)])],-1),w=a('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:SummaryC"><pre><code></code></pre></div>',3);function x(T,I,k,P,z,A){const t=c("ClientOnly");return i(),s("div",null,[d,u,o(t,null,{default:l(()=>[p]),_:1}),h,_,o(t,null,{default:l(()=>[y]),_:1}),S,o(t,null,{default:l(()=>[C]),_:1}),f,o(t,null,{default:l(()=>[v]),_:1}),b,o(t,null,{default:l(()=>[g]),_:1}),w])}var j=r(m,[["render",x]]);export{B as __pageData,j as default};
