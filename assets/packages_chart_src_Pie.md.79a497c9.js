...
<script type="module">
  ...
  new Pie()
      ...
      ;
<\/script>
`)])],-1),f=o('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:Pie"><pre><code></code></pre></div>',3);function v(x,y,w,b,C,V){const n=s("ClientOnly");return c(),l("div",null,[d,p,i(n,null,{default:a(()=>[u]),_:1}),_,i(n,null,{default:a(()=>[m]),_:1}),P,i(n,null,{default:a(()=>[g]),_:1}),f])}var I=r(h,[["render",v]]);export{S as __pageData,I as default};
