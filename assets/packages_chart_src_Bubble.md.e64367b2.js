...
<script type="module">
  ...
  new Bubble()
      ...
      ;
<\/script>
`)])],-1),m=o('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:Bubble"><pre><code></code></pre></div>',3);function v(f,B,y,x,C,w){const l=s("ClientOnly");return c(),i("div",null,[h,p,a(l,null,{default:n(()=>[u]),_:1}),b,_,a(l,null,{default:n(()=>[g]),_:1}),m])}var T=r(d,[["render",v]]);export{A as __pageData,T as default};
