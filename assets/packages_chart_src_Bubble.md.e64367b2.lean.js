...
<script type="module">
  ...
  new Bubble()
      ...
      ;
<\/script>
`)])],-1),m=o("",3);function v(f,B,y,x,C,w){const l=s("ClientOnly");return c(),i("div",null,[h,p,a(l,null,{default:n(()=>[u]),_:1}),b,_,a(l,null,{default:n(()=>[g]),_:1}),m])}var T=r(d,[["render",v]]);export{A as __pageData,T as default};
