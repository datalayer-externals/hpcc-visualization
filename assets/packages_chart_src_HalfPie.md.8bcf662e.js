...
<script type="module">
  ...
  new HalfPie()
      ...
      ;
<\/script>
`)])],-1),f=d('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:HalfPie"><pre><code></code></pre></div>',3);function P(m,g,v,x,y,b){const a=l("ClientOnly");return o(),s("div",null,[h,p,n(a,null,{default:r(()=>[u]),_:1}),n(a,null,{default:r(()=>[_]),_:1}),f])}var V=i(c,[["render",P]]);export{H as __pageData,V as default};
