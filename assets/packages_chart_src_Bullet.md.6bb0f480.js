...
<script type="module">
  ...
  new Bullet()
      ...
      ;
<\/script>
`)])],-1),b=o('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:Bullet"><pre><code></code></pre></div>',3);function g(C,x,S,w,B,y){const t=r("ClientOnly");return u(),a("div",null,[c,h,n(t,null,{default:l(()=>[p]),_:1}),m,n(t,null,{default:l(()=>[_]),_:1}),v,n(t,null,{default:l(()=>[f]),_:1}),b])}var $=s(d,[["render",g]]);export{k as __pageData,$ as default};
