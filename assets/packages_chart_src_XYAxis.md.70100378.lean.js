...
<script type="module">
  ...
  new XYAxis()
      ...
      ;
<\/script>
`)])],-1),v=a("",3);function k(C,P,S,I,Y,V){const t=o("ClientOnly");return h(),r("div",null,[p,i(t,null,{default:s(()=>[c]),_:1}),x,m,i(t,null,{default:s(()=>[u]),_:1}),_,A,g,i(t,null,{default:s(()=>[y]),_:1}),f,i(t,null,{default:s(()=>[w]),_:1}),T,i(t,null,{default:s(()=>[b]),_:1}),v])}var O=l(d,[["render",k]]);export{D as __pageData,O as default};
