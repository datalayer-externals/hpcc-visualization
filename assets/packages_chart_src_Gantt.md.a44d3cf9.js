...
<script type="module">
  ...
  new Gantt()
      ...
      ;
<\/script>
`)])],-1),w=l('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:Gantt"><pre><code></code></pre></div>',3);function A(G,T,P,C,S,I){const n=i("ClientOnly");return d(),o("div",null,[p,h,a(n,null,{default:s(()=>[u]),_:1}),_,m,g,a(n,null,{default:s(()=>[x]),_:1}),y,a(n,null,{default:s(()=>[f]),_:1}),v,a(n,null,{default:s(()=>[b]),_:1}),w])}var B=r(c,[["render",A]]);export{k as __pageData,B as default};
