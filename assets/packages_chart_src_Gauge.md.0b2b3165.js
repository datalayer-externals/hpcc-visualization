...
<\/script>
`)])],-1),x=o('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:Gauge"><pre><code></code></pre></div>',3);function b(G,D,T,V,C,F){const n=i("ClientOnly");return c(),s("div",null,[p,d,a(n,null,{default:l(()=>[h]),_:1}),g,a(n,null,{default:l(()=>[v]),_:1}),_,a(n,null,{default:l(()=>[m]),_:1}),y,a(n,null,{default:l(()=>[f]),_:1}),k,a(n,null,{default:l(()=>[w]),_:1}),x])}var A=r(u,[["render",b]]);export{j as __pageData,A as default};
