...
<script type="module">
  import "@hpcc-js/wc-observable";
<\/script>
`)])],-1),m=s("",13);function g(w,f,_,y,q,k){const r=i("ClientOnly");return d(),n("div",null,[b,c,a(r,null,{default:o(()=>[p]),_:1}),u,a(r,null,{default:o(()=>[v]),_:1}),m])}var O=l(h,[["render",g]]);export{T as __pageData,O as default};
