...
<script type="module">
  ...
  new Bullet()
      ...
      ;
<\/script>
`)])],-1),b=o("",3);function g(C,x,S,w,B,y){const t=r("ClientOnly");return u(),a("div",null,[c,h,n(t,null,{default:l(()=>[p]),_:1}),m,n(t,null,{default:l(()=>[_]),_:1}),v,n(t,null,{default:l(()=>[f]),_:1}),b])}var $=s(d,[["render",g]]);export{k as __pageData,$ as default};
