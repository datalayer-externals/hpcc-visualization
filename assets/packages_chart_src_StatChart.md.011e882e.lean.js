...
<script type="module">
  ...
  new StatChart()
      ...
      ;
<\/script>
`)])],-1),C=l("",3);function S(T,x,b,w,P,A){const a=s("ClientOnly");return d(),h("div",null,[p,n(a,null,{default:i(()=>[c]),_:1}),u,n(a,null,{default:i(()=>[m]),_:1}),_,g,n(a,null,{default:i(()=>[v]),_:1}),f,n(a,null,{default:i(()=>[y]),_:1}),C])}var k=r(o,[["render",S]]);export{V as __pageData,k as default};
