...
<script type="module">
  ...
  new Bar()
      ...
      ;
<\/script>
`)])],-1),g=o("",3);function v(y,B,b,A,C,w){const r=l("ClientOnly");return d(),i("div",null,[h,p,n(r,null,{default:a(()=>[u]),_:1}),_,n(r,null,{default:a(()=>[m]),_:1}),f,n(r,null,{default:a(()=>[x]),_:1}),g])}var T=s(c,[["render",v]]);export{P as __pageData,T as default};
