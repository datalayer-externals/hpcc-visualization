...
<script type="module">
  ...
  new Gantt()
      ...
      ;
<\/script>
`)])],-1),w=l("",3);function A(G,T,P,C,S,I){const n=i("ClientOnly");return d(),o("div",null,[p,h,a(n,null,{default:s(()=>[u]),_:1}),_,m,g,a(n,null,{default:s(()=>[x]),_:1}),y,a(n,null,{default:s(()=>[f]),_:1}),v,a(n,null,{default:s(()=>[b]),_:1}),w])}var B=r(c,[["render",A]]);export{k as __pageData,B as default};
