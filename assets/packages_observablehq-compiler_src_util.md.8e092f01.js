...
<script type="module">
  ...
  placeholder.text = JSON.stringify(notebook, undefined, 4);
<\/script>
`)])],-1);function _(k,g,f,v,S,y){const o=s("ClientOnly");return i(),a("div",null,[p,t(o,null,{default:n(()=>[d]),_:1}),h,t(o,null,{default:n(()=>[m]),_:1}),b,t(o,null,{default:n(()=>[u]),_:1})])}var j=l(c,[["render",_]]);export{T as __pageData,j as default};
