...
<script type="module">
  ...
  new QuarterPie()
      ...
      ;
<\/script>
`)])],-1),P=d('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:QuarterPie"><pre><code></code></pre></div>',3);function f(m,g,v,x,y,b){const r=s("ClientOnly");return o(),l("div",null,[h,p,a(r,null,{default:n(()=>[u]),_:1}),a(r,null,{default:n(()=>[_]),_:1}),P])}var V=i(c,[["render",f]]);export{Q as __pageData,V as default};
