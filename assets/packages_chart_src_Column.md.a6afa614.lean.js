...
<script type="module">
  ...
  new Column()
      ...
      ;
<\/script>
`)])],-1),x=i("",3);function g(v,y,A,w,V,b){const t=o("ClientOnly");return d(),s("div",null,[h,p,r(t,null,{default:a(()=>[u]),_:1}),m,r(t,null,{default:a(()=>[_]),_:1}),f,r(t,null,{default:a(()=>[C]),_:1}),x])}var B=l(c,[["render",g]]);export{T as __pageData,B as default};
