...
<script type="module">
  ...
  new Area()
      ...
      ;
<\/script>
`)])],-1),C=i('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:Area"><pre><code></code></pre></div>',3);function P(D,k,B,I,j,N){const n=s("ClientOnly");return p(),r("div",null,[d,a(n,null,{default:l(()=>[h]),_:1}),u,a(n,null,{default:l(()=>[_]),_:1}),m,f,x,A,a(n,null,{default:l(()=>[g]),_:1}),v,y,w,b,a(n,null,{default:l(()=>[V]),_:1}),T,a(n,null,{default:l(()=>[S]),_:1}),C])}var E=o(c,[["render",P]]);export{$ as __pageData,E as default};
