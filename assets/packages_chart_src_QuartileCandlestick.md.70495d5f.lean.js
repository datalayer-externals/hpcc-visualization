...
<script type="module">
  ...
  new QuartileCandlestick()
      ...
      ;
<\/script>
`)])],-1),b=a("",3);function y(T,k,P,Q,R,V){const n=o("ClientOnly");return d(),s("div",null,[h,p,i(n,null,{default:l(()=>[u]),_:1}),m,i(n,null,{default:l(()=>[_]),_:1}),f,x,g,i(n,null,{default:l(()=>[C]),_:1}),v,i(n,null,{default:l(()=>[w]),_:1}),b])}var M=r(c,[["render",y]]);export{A as __pageData,M as default};
