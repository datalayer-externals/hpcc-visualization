...
<script type="module">
  ...
  new HalfPie()
      ...
      ;
<\/script>
`)])],-1),f=d("",3);function P(m,g,v,x,y,b){const a=l("ClientOnly");return o(),s("div",null,[h,p,n(a,null,{default:r(()=>[u]),_:1}),n(a,null,{default:r(()=>[_]),_:1}),f])}var V=i(c,[["render",P]]);export{H as __pageData,V as default};
