import{_ as t,r as p,c as l,b as a,w as e,a as c,d as n,e as o,o as r}from"./app.8d0e5b28.js";const R='{"title":"Compiler","description":"","frontmatter":{},"headers":[{"level":2,"title":"Minimal JSON Notebook","slug":"minimal-json-notebook"},{"level":2,"title":"Hello World Example","slug":"hello-world-example"},{"level":2,"title":"MoreExamples","slug":"moreexamples"}],"relativePath":"packages/observablehq-compiler/src/compiler.md"}',i={},u=c(`<h1 id="compiler" tabindex="-1">Compiler <a class="header-anchor" href="#compiler" aria-hidden="true">#</a></h1><p>Observable HQ Notebook Compiler and Interpreter</p><h2 id="minimal-json-notebook" tabindex="-1">Minimal JSON Notebook <a class="header-anchor" href="#minimal-json-notebook" aria-hidden="true">#</a></h2><p>While the compiler supports and persists the entire Observable HQ Notebook (v3), it only needs a minimal subset to actually function:</p><div class="language-ts"><pre><code><span class="token keyword">interface</span> <span class="token class-name">Notebook</span> <span class="token punctuation">{</span>
...
<\/script>
`)])],-1);function q(x,N,j,I,E,C){const s=p("ClientOnly");return r(),l("div",null,[u,a(s,null,{default:e(()=>[d]),_:1}),k,m,a(s,null,{default:e(()=>[h]),_:1}),b,v,y,a(s,null,{default:e(()=>[w]),_:1}),g,f,a(s,null,{default:e(()=>[_]),_:1})])}var S=t(i,[["render",q]]);export{R as __pageData,S as default};
