import{_ as a,r as t,c as p,b as o,w as e,a as c,o as u,d as n}from"./app.8d0e5b28.js";const y='{"title":"@hpcc-js/timeline","description":"","frontmatter":{},"headers":[{"level":2,"title":"Exported Widgets","slug":"exported-widgets"},{"level":2,"title":"Stand-alone HTML Example","slug":"stand-alone-html-example"},{"level":2,"title":"Getting Started with @hpccjs","slug":"getting-started-with-hpccjs"}],"relativePath":"packages/timeline/README.md"}',l={},i=c("",8),r=n("hpcc-vitepress",{style:{width:"100%",height:"600px"}},[n("pre",null,[n("code",null,`<div id="target" style="width:100%;height:600px">
</div>
<script type="module">
...
<\/script>
`)])],-1);function k(g,h,d,m,q,_){const s=t("ClientOnly");return u(),p("div",null,[i,o(s,null,{default:e(()=>[r]),_:1})])}var w=a(l,[["render",k]]);export{y as __pageData,w as default};
