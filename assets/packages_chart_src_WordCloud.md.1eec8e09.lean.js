...
<script type="module">
  ...
  new WordCloud()
      ...
      ;
<\/script>
`)])],-1),y=i("",3);function v(b,x,T,F,W,z){const t=l("ClientOnly");return d(),s("div",null,[c,p,a(t,null,{default:o(()=>[u]),_:1}),g,a(t,null,{default:o(()=>[m]),_:1}),_,a(t,null,{default:o(()=>[f]),_:1}),C,a(t,null,{default:o(()=>[w]),_:1}),y])}var V=r(h,[["render",v]]);export{S as __pageData,V as default};
